      ...
      <div class="container-fluid">
        <div class="row header">
          ...
          <div class="col-sm-10">
            ...
            <div class="polPanel">
              <div> <span class="headingFont">ENTRANCES</span>    
              <template>         
              ...
              <div> <span class="headingFont">DAY LENGTH</span>
                <div class="row polSubSection">
                  <div class="col">
              ...
              <div> <span class="headingFont">NUMBER OF AGENTS</span>
                <div class="row polSubSection">
                  <div class="col">
                    <span>Quantity</span>
                    <div class="polValue"> Input</div>                 
              ...
              <div> <span class="headingFont">CONTACT DISTANCE</span>
                <div class="row polSubSection">
                  <div class="col">
              ...
              <div> <span class="headingFont">SHIFTS</span>
                <div class="row polSubSection">
                  <div class="col">
            ...
            <div class="polPanel">
              <div class="polDesc">The meetings policy controls when and where meetings take place as well who attends them. 
                A meeting is defined as any gathering of people in the same physical space. 
                The parameters listed below are used to generate meetings and attendee list randomly. In the future, 
                the possibility will be given to manually add specific meetings that always take place (e.g. classroom instructions).
              </div>
              <div> <span class="headingFont">MEETING DURATION</span>
                <div class="row polSubSection">
                  <div class="col">
            ...
            <div class="polPanel">
             <div class="polDesc">
               The scheduling policy controls what items are added to people’s schedules and itineraries. 
                It can be used for example to disallow meetings or cafeteria visits. 
               A scheduling policy is made of a list of scheduling rules where each rule is as follows:
             </div>
             <div class="row polSubSection">
                <div class="col">
                  <span>Purpose</span>
            ...
            <div class="polPanel">
              <div class="polDesc">
                A traffic policy is made of list of circulation rules where each rule is as follows:
              </div>
              <div class="row polSubSection">
                <div class="col">
                  <span>Floor</span>
...
.policyBtn {
 ...
 #policiesLayout .col-sm-2, .col-sm-10 {
   text-align: left;

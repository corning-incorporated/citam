...
def test_load_floor_oneway_net_file_not_found(simple_facility_floorplan,
                                              monkeypatch,
                                              datadir
                                              ):

    monkeypatch.setenv("CITAM_CACHE_DIRECTORY", str(datadir))
    nav = Navigation([simple_facility_floorplan],
                     "test_simple_facility",
                     None
                     )
...
def test_init_hallway_graph_not_found(simple_facility_floorplan,
                                      monkeypatch,
                                      datadir):
    ...
    floor_dir = os.path.join(
                    datadir,
                    'floorplans_and_nav_data/test_simple_facility/floor_0/'
                    )
...
def test_init_navnet_not_found(simple_facility_floorplan,
                               monkeypatch,
                               datadir):

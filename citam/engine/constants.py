...
ONE_WAY_POSITIVE_DIRECTION = 1
ONE_WAY_NEGATIVE_DIRECTION = -1
TWO_WAY_TRAFFIC = 0
...
OPTIONAL_SPACE_METADATA = ['space_category',
                           'floor',
                           'department',
                           'capacity',
                           'square_footage'
...
SUPPORTED_SPACE_FUNCTIONS = ['circulation',
                             'office',
                             'lab',
                             'restroom',
                             'cafeteria',
...
DEFAULT_SCHEDULING_RULES = {
    ...
    OFFICE_WORK:     {"purpose": OFFICE_WORK,
                      "min_duration": 600,
                      "max_duration": 7200,
                      "min_instances": 2,
                      "max_instances": 10
                      },
    RESTROOM_VISIT:  {"purpose": RESTROOM_VISIT,
                      "min_duration": 300,
                      "max_duration": 900,
                      "min_instances": 1,
                      "max_instances": 4
                      },
    CAFETERIA_VISIT: {"purpose": CAFETERIA_VISIT,
                      "min_duration": 900,
                      "max_duration": 3600,
                      "min_instances": 0,
                      "max_instances": 2},
